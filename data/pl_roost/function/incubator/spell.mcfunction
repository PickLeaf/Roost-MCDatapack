advancement grant @s only pl_roost:incubator
...
data modify storage pl_roost:var stop \
    set value 1b
function nutlet:-m/facing/block_axis_align {handler:"pl_roost:incubator/setup"}
...
function nutlet:-m/facing/block_axis_align {handler:"pl_roost:incubator/show_schematic"}